...
const userCtrl = {
  register: async (req: Request, res: Response) => {
    try {
      ...
      await transporter.sendMail({
        from: "Accommodation Booking || Register Verification",
        to: to,
        subject: "Email Verification Link - Accommodation Booking",
        html: `<!doctype html>
    <html lang=en>
    <head>
    <meta charset=utf-8>
    ...
    <title>Accommodation Booking || Register Verification</title>
    </head>
    <body>
    <div class="container-fluid bg-primary text-center"><h1 class="text-white p-5">Accommodation Booking || Register Verification</h1></div>
  ...
  login: async (req: Request, res: Response) => {
    try {
      ...
      await transporter.sendMail({
        from: "Accommodation Booking || Login Verification",
        to: user.email,
        subject: "Email Verification Link - Accommodation Booking",
        html: `<!doctype html>
    <html lang=en>
    ...
    <title>Accommodation Booking || Login Two Step Verification</title>
    </head>
    <body>
    <div class="container-fluid bg-primary text-center"><h1 class="text-white p-5">Accommodation Booking || Login Two Step Verification</h1></div>
  ...
  forgotPassword: async (req: Request, res: Response) => {
    try {
      ...
      await transporter.sendMail({
        from: "Accommodation Booking || Forgot Password",
        to: user.email,
        subject: "Email Verification Link - Accommodation Booking",
        html: `<!doctype html>
<html lang=en>
...
<title>Accommodation Booking || Forgot Password</title>
</head>
<body>
<div class="container-fluid bg-primary text-center"><h1 class="text-white p-5">Accommodation Booking || Forgot Password</h1></div>
