...
const userCtrl = {
  ...
  register: async (req, res) => {
    try {
      ...
      await transporter.sendMail({
        from: "Accommodation || Register Verification",
        to: to,
        subject: "Email Verification Link - Accommodation",
        html: `<!doctype html>
    <html lang=en>
    <head>
    <meta charset=utf-8>
    ...
    <title>Accommodation || Register Verification</title>
    </head>
    <body>
    <div class="container-fluid bg-primary text-center"><h1 class="text-white p-5">Accommodation || Register Verification</h1></div>
  ...
  login: async (req, res) => {
    try {
      ...
      await transporter.sendMail({
        from: "Accommodation || Login Verification",
        to: user.email,
        subject: "Email Verification Link - Accommodation",
        html: `<!doctype html>
    <html lang=en>
    ...
    <title>Accommodation || Login Two Step Verification</title>
    </head>
    <body>
    <div class="container-fluid bg-primary text-center"><h1 class="text-white p-5">Accommodation || Login Two Step Verification</h1></div>
  ...
  forgotPassword: async (req, res) => {
    try {
      ...
      await transporter.sendMail({
        from: "Accommodation || Forgot Password",
        to: user.email,
        subject: "Email Verification Link - Accommodation",
        html: `<!doctype html>
<html lang=en>
...
<title>Accommodation || Forgot Password</title>
</head>
<body>
<div class="container-fluid bg-primary text-center"><h1 class="text-white p-5">Accommodation || Forgot Password</h1></div>
